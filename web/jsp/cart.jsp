            ...
            <c:forEach items="${sessionScope.cart}" var="entry">
                <tr>
                   <td width="60" width="40%" style="border-right: 1px solid gray;">
                       <img src="${pageContext.request.contextPath}/${entry.key.pro_min_img}" width="70" height="60" />
                   </td>

                    <td width="30%" style="border-right: 1px solid gray;">
                        <a target="_blank">${entry.key.pro_name}</a>
                    </td>

                    <td width="20%" style="border-right: 1px solid gray;">
                        ￥${entry.key.shop_price}
                    </td>
                    ...
                    <td width="15%" style="border-right: 1px solid gray;">
                        <span class="subtotal">￥${entry.key.shop_price*entry.value}</span>
                    </td>

                    <td style="border-right: 1px solid gray;">
                        <a href="${pageContext.request.contextPath}/CartServlet?method=deleteFromCart&proId=${entry.key.pro_id}">删除</a>
                    </td>
                </tr>
            </c:forEach>
